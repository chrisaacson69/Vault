...
created: 2026-04-15
published: true
title: Career Strategy — The Performative Loop
summary: The job search IS the portfolio. Every tool we build to land the role proves we can do the role.
...
The process is self-referencing. A "performative contradiction" would be claiming AI competency while job-searching manually. The performative proof is the opposite — the search method validates the claim. The same structure as the vault's [reaffirmation through denial](../research/philosophy/tangents/history-of-philosophy/15-aristotle-logic.md): you cannot deny the thesis without demonstrating it.

## Target Level: Director of AI Engineering / AI Transformation

Based on [role landscape research](./role-landscape.md), the director level is the right target. Not because of title inflation — because the responsibilities match:
...
- Nordstrom: Director of Engineering, AI/Agent Enablement ($200K-$332K, Seattle)
- Focus: agent platforms, reusable frameworks, engineering practices

**2. Director of AI Transformation / Enablement** — Changing how a company uses AI
- Charles Schwab: Director, AI Fluency & Enablement Programs ($190K-$317K)
- Comcast: Director, AI Planning & Enablement
- Focus: adoption strategy, operating models, governance, upskilling
- 21% of these postings require change management skills

**3. Director of Agentic AI** — The cutting edge
- Experian: Director, Agentic AI/Automation ($153K-$275K, remote)
- Focus: multi-agent orchestration, autonomous workflows, RPA-to-agentic evolution
...
Director-level total comp ranges from $250K-$400K (enterprise) to $500K-$943K+ (FAANG). Education requirements are softening — only 60% require a degree. Full breakdown in [role-landscape.md](./role-landscape.md) and [active-postings.md](./active-postings.md).

## The Demonstration Pipeline

Nine tools across three phases — each one both a career tool and a portfolio piece. Full specs and build order in [tools-roadmap.md](./tools-roadmap.md).
...
This is the [Cyborg Model](../research/cyborg-model.md) applied to career development. The human provides judgment, taste, and strategic direction. The AI executes research, synthesis, generation, and evaluation.
