...
This connects to a deep theme: the [cognitive vs. motor](../research/cognitive-vs-motor.md) split isn't just about AI architecture — it's about human nature. We can reason about anything, but at some point someone has to press a button, sign a contract, deploy the code, make the call. The gap between understanding and acting is where most ideas die.
