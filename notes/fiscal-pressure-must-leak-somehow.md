...
**Links:** [Lyn Alden Trade Deficit Analysis](../research/economics/lyn-alden-trade-deficit-analysis.md), [Accounting Identities as Domain-Matching](../research/economics/accounting-identities-as-domain-matching.md), [Inflation](../research/economics/inflation.md), [Business Cycles](../research/economics/business-cycles.md), [Equation of Exchange](../research/economics/equation-of-exchange.md), [Civilizational Cycles](../research/philosophy/dynamics/civilizational-cycles/README.md), [Opposing Forces](../research/philosophy/dynamics/opposing-forces.md), [Structure vs Adaptability](./structure-vs-adaptability.md)
...
- Federal deficit: ~$1.8T/year, ~6.3% of GDP
- Federal debt: ~$36T, ~125% of GDP
- Interest payments: ~$880B/year, exceeding defense spending
- Structural drivers (entitlements, demographics): worsening trajectory
- Political path to fiscal balance: none politically viable
...
**What it is:**
- A structural prediction about *what the pressure release looks like* given the fiscal trajectory
- An application of conservation-of-imbalance to fiscal rather than trade flows
- An honest acknowledgment that the political system has revealed-preference against the "fiscal discipline" and "real growth" channels, leaving the other three to absorb the pressure

**What it isn't:**
- A timing forecast (could be 5 years, could be 50)
- A magnitude forecast (could be mild distributed pain, could be acute crisis with concentrated trigger)
...
[economics](../tags/economics.md), [epistemology](../tags/epistemology.md), [meta-musing](../tags/meta-musing.md), [civilizational-cycles](../tags/civilizational-cycles.md), [scope-confusion](../tags/scope-confusion.md)
