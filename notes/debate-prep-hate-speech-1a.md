...
- **Influence:** I say something → you process it through your own agency → you decide how to respond. Your agency is intact.
- **Control:** I physically restrain you, take your property, threaten your body. Your agency is overridden.
...
- Culture (blasphemy is hate speech in Pakistan, protected speech in the US)
- Decade (criticizing gay marriage was mainstream in 2004, "hate speech" by 2024)
- Political power (whoever holds office decides what's hateful)
...
- **Sedition Act (1798):** Passed to protect national security → used to jail journalists critical of President Adams
- **Espionage Act (1917):** Passed for wartime security → used to jail anti-war protesters (Eugene Debs got 10 years for a speech)
- **UK hate speech laws:** Started with racial incitement → expanded to include "grossly offensive" online speech → police investigating Twitter posts and arrested a man for quoting a limerick
...
- Moral agents must be free agents — you can't have moral choice without freedom to choose
- Suppressing speech doesn't produce moral people — it produces people who hide their immorality
- Hate speech laws treat listeners as incapable of exercising agency against bad ideas
- This *infantilizes* the people they claim to protect
...
- The pre-commitment works because it's unconditional
- The moment you condition it ("free speech, except when..."), you've created a censorship mechanism
- Every historical example shows that mechanism expands
...
- **Fraud:** Deceptive speech causing someone to act against their interests under false pretenses (already illegal)
- **Direct incitement:** Ordering a specific act of violence against a specific target (already illegal — Brandenburg v. Ohio)
- **True threats:** Credible, specific threats of physical harm (already illegal)
...
- Lead with the challenge ("send me something that harms me") — it's visceral and unanswerable
- Use the influence vs control distinction early — it reframes the entire debate
- Historical examples are your ammunition — scope creep is VISIBLE, not theoretical
- Stay calm when the opponent appeals to emotion about marginalized groups — acknowledge the concern, then redirect to the structural argument
