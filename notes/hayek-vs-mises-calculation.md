...
- **Gödel:** The formal system (map) can't capture all truths about the territory
- **Numbers:** Agent-imposed abstractions that approximate reality but aren't reality
- **Deontology/consequentialism:** You can't calculate consequences across a computationally irreducible system
- **Prices:** Emergent outputs of a process, not data points to be collected. The map (simulation) is always less than the territory (actual market)
