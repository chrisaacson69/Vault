...
- [The Constitutive Middle — Two Dialectics](../research/philosophy/morality/constitutive-middle-dialectics.md) — operational playbook: walk a global anti-realist (logic is constitutive) and a theistic realist (read the law off the nature; God = Author, not truth-maker) to constitutive realism
- [Rights Don't Actually Exist, Only Force (Wilson vs 5)](../research/debates/wilson-rights-dont-exist-only-force.md) — "rights reduce to force" conflates the enforcement layer with the justification layer; non-realism about rights leaves the comparison of value-systems fully open
- [Christians Have as Much Right to Rule as Secularists (Wilson vs 5)](../research/debates/wilson-christians-right-to-rule.md) — a coercive law owes the governed a *warrant they can weigh*, applied symmetrically; source of conviction ≠ public justification; the leveler is the door, procedure is the room
- [Do Atheists Benefit from Living in a Christian Society? (Wilson vs 5)](../research/debates/wilson-atheists-benefit-christian-society.md) — the outcomes warrant is *shared*, not Christian-proprietary (Wilson retreats to it himself); benefit licenses adopting the norms + crediting the carrier, not adopting the creed; wisdom-compression / Chesterton's Fence
- [Force Doctrine — The Theory](../research/philosophy/morality/force-doctrine.md) — rights = compelled/external layer (force makes this) vs duties = voluntary/internal layer (force is constitutively impotent — coerced virtue isn't virtue); duty-atrophy → force-hypertrophy; God = Author not truth-maker
...
- [Libertarian Legal Theory](../research/philosophy/morality/legal-theory/README.md) — Applied legal philosophy from a big-L Libertarian framework.
...
- [Objectivism vs. Libertarian Voluntarism (Leibowitz vs Lloyd)](../research/debates/objectivism-libertarianism-leibowitz-lloyd.md) — seeds the "prescribing anti-realist self-refutes" move (advocacy performatively presupposes correctness) and the under-claiming mirror to Hoppe's over-derivation.
- [Sitch vs. Ryan Mullally — Birthright Citizenship & Natural Law](../research/debates/sitch-mullally-birthright-citizenship.md) — "natural law" launders a smuggled objective, and since the *default is defect* cooperative morality is constructed anti-natural structure; advances Morality Open-Problems #2 (one should think) & #4 (Ring of Gyges / God-as-infinite-iterator / EGT)
- [Chris vs. Ryan Mullally — call-in stint](../research/debates/chris-mullally-callin.md) — constitutive/elective deployed live; three grounding facts (think/live/exist) and their unresolved tension with capital punishment
- [Corruption — The Floor Under the Mud-Sling](../research/philosophy/morality/legal-theory/corruption.md) — corruption as betrayal-of-trust is a distinct axis from moral content: an office can faithfully (uncorruptly) execute a monstrous charter; calling an adversarial-but-chartered act "corrupt" is scope confusion
- [Constructed ≠ Arbitrary](../research/philosophy/constructed-not-arbitrary.md) — generalizes [constitutive/elective](../research/philosophy/morality/constitutive-elective.md) beyond morality; "it's just a social construct" is the bottom-right cell (mind-dependent + elective) swallowing the bottom-left one (mind-dependent + constitutive)
