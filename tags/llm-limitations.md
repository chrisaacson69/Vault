...
- [Eyes and Ears for LLMs — the Audio Translator](../research/eyes-and-ears-for-llms.md) — VLM "distance judging" is partly illusion — semantic content strong, metric/spatial weak; native-audio LLMs are secretly speech models
