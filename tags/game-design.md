...
- [Hangman — Solving Both Sides](../research/gaming/hangman-solving-both-sides.md) — solving *both* sides yields a rules verdict: under near-optimal play the fair miss allowance is 1–8 by word length — every number **except 6**, the one everybody plays
