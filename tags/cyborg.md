...
- [Set Mastering Pipeline — "Cyborg DJ"](../projects/set-mastering/README.md)
...
- [Eyes and Ears for LLMs — the Audio Translator](../research/eyes-and-ears-for-llms.md) — the translator is what lets the LLM read the score — G6's text surface feeds the CyborgDJ engine unchanged
