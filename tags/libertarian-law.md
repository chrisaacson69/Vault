...
- [Christians Have as Much Right to Rule as Secularists (Wilson vs 5)](../research/debates/wilson-christians-right-to-rule.md) — coercive law owes the governed a symmetric, accessible warrant; the proceduralist "we vote on conclusions, not whose ideology wins" is the one counter Wilson can't dissolve
...
- [The Represented Unit](../research/philosophy/morality/legal-theory/represented-unit.md) — federalism as a capture-resistance mechanism (capture is an ROI decision; distributed power isn't worth buying); its two purposes = proximity (sorting) + surface area; *may* vs. *must* delegation
- [Corruption — The Floor Under the Mud-Sling](../research/philosophy/morality/legal-theory/corruption.md) — a non-indexical definition (diversion of entrusted power from constitutive purpose); the legal×corrupt four-quadrant grid; adversarial ≠ corrupt; whose-trust resolves the spy/NGO case
- [Administrative Agencies and the Power to Execute](../research/philosophy/morality/legal-theory/administrative-agencies.md) — unitary-executive reading; the four grounded cases (Humphrey's/Seila/Loper Bright/Slaughter) + the Fed carve-out; gap-filling IS lawmaking, so the real question is *who holds the discretion and can they be fired*; the nondelegation-vs-executive-gap-filling fork
