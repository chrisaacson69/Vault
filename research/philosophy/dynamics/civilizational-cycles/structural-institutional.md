...
title: "Structural-Institutional Analysts"
---
...
- A 2023 PLOS ONE study challenged the theory empirically, finding that automation (not labor oversupply) better explains wage polarization, and that elite overproduction did not predict political instability as well as inequality alone.
  - **Read these two findings separately — only the second is actually adverse.** ([Econ Nerds review](../../../debates/econ-nerds-inequality-myths.md), 2026-08-21.) *Wage polarization* and *elite overproduction* are **not competing explanations**: polarization is demand-side and concerns the **deskilled middle** (automation destroys routine tasks, so a 1963 skill set can't clear the poverty line); overproduction is supply-side and concerns the **overcredentialed top** (too many aspirants per elite slot, so expected status is unreachable). Different populations, different failure modes, simultaneously satisfiable. The genuinely damaging half is the **second**: on Turchin's own turf, *inequality alone* out-predicted his mechanism.
  - **Chris's refinement — "maybe Turchin was being too precise."** If the real mechanism is **credential/status inflation generally** — a positional good whose entry requirement inflates as more people acquire it, covering *both* the frustrated top *and* the middle needing more credentials for the same 1963 job — then a narrow aspirant/position operationalization is measuring a **subset** and should underperform, which would explain the PLOS result **without abandoning the mechanism**. Unusual and testable: *being less precise would make the theory more predictive.* Developed as the labor-market instance of the ratchet in [Subsistence vs. Participation §6](../../../economics/subsistence-vs-participation.md).
...
## Tags
[philosophy](../../../../tags/philosophy.md), [civilizational-cycles](../../../../tags/civilizational-cycles.md), [economics](../../../../tags/economics.md)
