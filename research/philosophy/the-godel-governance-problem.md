...
**Why it fails:** The state IS a monopoly on force. [Opposing forces](./opposing-forces.md) predicts it will expand beyond its original justification. [Registration and scope creep](./legal-theory/registration-and-scope-creep.md) documents this expansion across every regulatory mechanism. The [government formation](./legal-theory/government-formation.md) analysis shows that once exit is foreclosed (and states systematically foreclose exit), the only remaining discipline is voice — voting, protest, litigation — which is [dramatically weaker than exit](./legal-theory/government-formation.md) as a feedback mechanism.
