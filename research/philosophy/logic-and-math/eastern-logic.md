...
**Vault connection:** This is the [Translation Problem](./the-translation-problem.md) recognized 2,000 years early. The Nyaya logicians knew that formal validity alone isn't enough — you have to bridge from the formal to the real. Their five-step structure builds the bridge into the logic itself rather than treating it as a separate pre-logical step.
...
This anticipates Ferdinand de Saussure's structuralist linguistics by 1,400 years — the idea that meaning comes from differences, not from inherent properties. It also anticipates the vault's [Relational Objectivity](../epistemology/relational-objectivity.md) framework: meaning is relational, not intrinsic, but that doesn't make it subjective.
...
**What this violates:**
- Corner 3 violates the **Law of Non-Contradiction** (P ∧ ¬P)
- Corner 4 violates the **Law of Excluded Middle** (¬(P ∨ ¬P))
- Together they violate both simultaneously
...
**Western parallels:**
- Corner 3 = **Priest's dialetheism** (true contradictions), developed ~1,800 years later
- Corner 4 = **Intuitionistic logic's** rejection of excluded middle, developed ~1,800 years later
- The full catuskoti = closest to **Belnap's four-valued logic** (True, False, Both, Neither), developed ~1,850 years later
- The "the question is malformed" move = **Wittgenstein's** "Whereof one cannot speak, thereof one must be silent" — similar spirit, 1,800 years later
...
4. In some respect, indeterminate (without specifying a comparison, the question has no definite answer)
5–7. Combinations of the above

This looks exotic but maps precisely to the vault's [Relational Objectivity](../epistemology/relational-objectivity.md) framework: facts can be **relational without being subjective.** "The object weighs 5 kg" is intrinsic. "The object is heavy" is relational (depends on context). The relational fact is objective (given the context, there's a right answer), but it's not intrinsic (it depends on the comparison class).
...
- "A white horse is not a horse" (Gongsun Long) — a semantic paradox about whether the species term includes or excludes specific instances. Parallels the problem of universals.
- The sorites paradox (in Mohist form) — at what point does a continuous change produce a categorical shift?
...
## Tags
[philosophy](../../../tags/philosophy.md), [logic](../../../tags/logic.md), [epistemology](../../../tags/epistemology.md), [history](../../../tags/history.md)
