...
title: "The Scope Confusion Thesis"
---
...
**Links:** [The Objectivism Boundary](./objectivism-boundary.md) — specimen: reading population-scale *explanation* (EGT) as population-scale *value* is this page's error, and it is the move a collectivist reading of Objectivism makes, [Morality](./README.md), [Legal Theory](./legal-theory/README.md), [Mens Rea](./legal-theory/mens-rea.md), [Opposing Forces](../dynamics/opposing-forces.md), [Civilizational Cycles](../dynamics/civilizational-cycles/README.md), [Demolition Man Analysis](../../demolition-man-analysis.md), [Insurance](../../economics/insurance.md), [The Weighting Problem](../epistemology/weighting-problem.md), [Absolutes and Differentials](../epistemology/absolutes-and-differentials.md) — **sibling thesis**: same "the disagreement is not where the participants think it is" shape, on the measurement-frame dimension rather than the enforcement-regime one, [The Fallacy Fallacy](../tangents/the-fallacy-fallacy.md), [LiquidZulu Course 7](../liquidzulu/course-07-law-subset-of-ethics.md) — "ought is ought" denies the gradient by name while asserting a positive ethical duty (save your drowning child) that his own law does not enforce: the gradient used and unnamed
...
"Don't steal" enforced by conscience — morality.
"Don't steal" enforced by community ostracism — ethics.
"Don't steal" enforced by courts compelling restitution — law.
...
**Principles without democracy** is tyranny — even good principles need consent of the governed to be legitimate.
**Democracy without principles** is mob rule — 99% agreement doesn't make something right.
**The friction structure** is the buffer between them. It doesn't prevent decay — nothing does — but it determines the *rate* of decay.
...
**Denying scope distinctions entirely (utopian error):**
Cocteau in [Demolition Man](../../demolition-man-analysis.md) — every preference is optimized, every deviation is illegal. There is no private morality because all morality is law. This is the ultimate scope confusion: collapsing all three regimes into one.
...
The civilizational decay ratchet has a developmental interpretation through [Kohlberg's stages](#kohlberg----stages-of-moral-development). If moral maturity means needing *less* external enforcement (post-conventional: act on self-determined principles), then the ratchet — pushing norms up into law — is a civilizational regression on Kohlberg's scale.
...
*Source: [Nobel Lecture — Economic Performance Through Time](https://www.nobelprize.org/prizes/economic-sciences/1993/north/lecture/)*
...
*Source: [Order Without Law — Harvard University Press](https://www.hup.harvard.edu/books/9780674641693)*
...
*Source: [Hart-Devlin Debate — Wikipedia](https://en.wikipedia.org/wiki/Hart%E2%80%93Devlin_debate), [The Limits of Law — Stanford Encyclopedia of Philosophy](https://plato.stanford.edu/entries/law-limits/)*
...
*Source: [Polycentric Governance of Complex Economic Systems — Nobel Lecture](https://www.nobelprize.org/uploads/2018/06/ostrom_lecture.pdf)*
...
*Source: [Kohlberg's Stages — Simply Psychology](https://www.simplypsychology.org/kohlberg.html)*
...
2. **A theory of legitimate scope transitions.** Some norms *should* be promoted (e.g., the abolition of slavery was a moral claim that became legal). What distinguishes legitimate promotion from scope confusion? Candidate criteria:
   - Near-universal utility agreement (necessary but not sufficient)
   - Passes the principled gate (no victim, no crime — or equivalent)
   - Cross-civilizational convergence (tracking real patterns, not local bias)
   - Passes the friction structure (survives deliberation, amendment process, judicial review)
