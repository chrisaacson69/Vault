...
**Links:** [Legal Theory](./README.md), [Defensive Force](./defensive-force-and-collateral-damage.md), [Mens Rea](./mens-rea.md), [Morality Framework](../README.md), [Action/Inaction Asymmetry](../action-inaction-asymmetry.md), [Scope Confusion](../scope-confusion.md), [The Godel Governance Problem](../../dynamics/the-godel-governance-problem.md)
...
### 1. Restitution to Survivors

Transfer the victim's restitution claim to next of kin (consistent with punishment-as-property-right from [defensive force](./defensive-force-and-collateral-damage.md)). The murderer owes the family:

- Financial restitution — lost income, funeral costs, dependency damages
- Labor — forced work with earnings directed to the family
...
### 2. Incarceration (Containment)

Remove the murderer from society to prevent further aggression.

**What it achieves:** Defense — stops the ongoing threat. Society is protected. This is the strongest justification because it maps directly to the [defensive force](./defensive-force-and-collateral-damage.md) framework: containment is the minimum force necessary to prevent future aggression from this specific person.
...
### The Consequentialist Case (steelman)
...
### The Hard Case: Murder From Custody
...
- The aggression is ongoing (murders continue)
- Containment (the gentlest means) has been tried and failed
- Execution may genuinely be the minimum force necessary to stop the active threat
- This is defense, not retribution
...
## What the Framework Can Say Clearly

1. **Restitution for murder is impossible.** Every option is a workaround. Honest frameworks admit this rather than pretending any remedy "makes whole."

2. **Containment is the primary justification for any response.** The strongest argument for incarceration (or execution) is defensive — preventing future aggression — not punitive.

3. **The death penalty is justified in principle for the narrow case of ongoing aggression from custody.** This is defense, not retribution, and meets the framework's requirements.

4. **The death penalty as general policy is a scope problem.** The systemic risk of granting the state execution power outweighs the marginal deterrent benefit, because the power expands and the state monopoly can't be trusted with proportionality.

5. **The consequentialist calculation is not wrong — it's incomplete.** The depth-1 calculation (lives saved vs lives taken) misses the institutional effects at depth 2+ (scope creep, erosion of trust, racial disparity in application, political incentive to expand).
...
- Can the "ongoing aggression from custody" case be addressed by supermax isolation rather than execution? If so, the gentleness principle eliminates execution even in the hard case.
- How does the framework handle serial killers who are caught, released (parole/error), and kill again? Each release-and-kill cycle is an institutional failure that strengthens the containment argument but also exposes its limits.
- Is there a meaningful distinction between "the state executes" and "the state permits the victim's family to execute"? The second might be consistent with the framework even if the first isn't.

## Tags
[libertarian-law](../../../../tags/libertarian-law.md), [morality](../../../../tags/morality.md), [philosophy](../../../../tags/philosophy.md)
