...
**Links:** [Legal Theory](./README.md), [Morality](../README.md), [Mens Rea](./mens-rea.md), [Government Formation](./government-formation.md), [LiquidZulu Course 3 — Homesteading](../../liquidzulu/course-03-homesteading.md) — the apodictic version of this page's comparative derivation; agrees on exclusive direct control as the fact, files it under "ownership" anyway, [LiquidZulu Course 4 — Contract Theory](../../liquidzulu/course-04-contract-theory.md) — his voluntary-slavery section makes this page's slavery test and bundle argument in his own words, and keeps the word "ownership" anyway
...
Separating the two:
- **Bodily autonomy** stands on its own as a brute physical fact + conflict avoidance
- **Property rights** stand on their own via scarcity + conflict avoidance + first use
- Neither depends on the other
- Attacking "self-ownership" no longer threatens the entire framework
- The semantic debate about whether "ownership" is the right word for bodily control becomes irrelevant to the property rights question
...
Does dropping self-ownership weaken individual responsibility? The mob boss / hitman scenario from the [mens rea debate](./mens-rea.md): if we don't ground agency in "self-ownership," can the boss claim he "owns" the hitman and therefore bears responsibility instead?
