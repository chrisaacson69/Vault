...
title: "Registration, Rights, and Government Scope Creep"
---
...
- No age restriction on ownership (children can own cars)
- No background check to purchase
- No restrictions on type (you can buy any vehicle — NASCAR, semi truck, tank)
- No restrictions on private-property use
- Just a basic competency test to operate one in public spaces
...
- **1st Amendment** — the tools of communication (speech, press, assembly)
- **2nd Amendment** — the tools of defense (arms)
- **3rd Amendment** — the sanctity of the home (no quartering)
- **4th Amendment** — security of person and property (no unreasonable search)
