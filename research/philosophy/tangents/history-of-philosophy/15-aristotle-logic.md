...
**Source:** [YouTube](https://www.youtube.com/watch?v=1JyvbBeYmcA) (40:33)
**Links:** [Series Index](./README.md), [Episode 14: Aristotle's Epistemology](./14-aristotle-epistemology.md)
...
The three terms:
- **Minor term:** subject of the conclusion (Socrates)
- **Major term:** predicate of the conclusion (mortal)
- **Middle term:** appears in each premise but not in the conclusion (man)
...
- **Law of Contradiction:** Nothing can be A and non-A at the same time and in the same respect
- **Law of Excluded Middle:** Everything is either A or non-A at a given time and in a given respect (the "middle" — sort-of-A, partly-not-A — is excluded)
- **Law of Identity:** A is A (formally defined later, ~12th century, by Antonius Andreas, but implicit throughout Aristotle and "obviously the same essential point" as the other two)
...
> Skeptic: "The law of contradiction is false."
> Aristotle: "I'm glad to hear that you accept it."
> Skeptic: "What? I just said it's false!"
> Aristotle: "I'm glad you are such an avid champion of the law of contradiction."
> Skeptic: "I *reject* it. Everything is A and not-A."
> Aristotle: "...If it's false, it's false. After all, A is A."
