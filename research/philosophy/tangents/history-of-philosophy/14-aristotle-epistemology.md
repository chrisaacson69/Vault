...
**Source:** [YouTube](https://www.youtube.com/watch?v=pmLM0669Als) (48:41)
**Links:** [Series Index](./README.md), [Episode 13: Aristotle Intro](./13-aristotle-intro.md)

---

## The Argument

### Part I: Tabula Rasa — No Innate Ideas
...
### Part II: The Validity of the Senses
...
### Part III: Concept Formation by Abstraction
...
1. **Sense experience.** Some creatures can't retain sense data — each sensation is gone immediately. (Salmon are "supposed to be like that — I don't know how anybody would know.")

2. **Memory.** Some creatures (and certainly humans) retain past sense experiences.

3. **Abstraction.** Unique to man. After repeated similar percepts, a person detects common denominators, focuses selectively on them while ignoring differences, and forms a concept. We see green thing, green thing, green thing — and at some point we "get the message" that there's something similar, even if the shapes, sizes, and locations differ. We focus on it and form the concept *green*.
...
### Part IV: The Answer to Plato on Perfection
...
### Part V: The Goal of Knowledge — The "That" and the "Why"
...
### Part VI: Nature Determines Behavior
...
- Why does this boil at a certain temperature? Because it's water, not sand.
- Why does this explode? Because it's gunpowder, not paper.
- Why does this fly? Because it's a bird, not a teaspoon.
...
### Part VII: The Theory of Definition
...
1. **Genus** — the wider general class (what fundamental kind of thing it is)
2. **Differentia** — what distinguishes it from everything else within that genus

Examples:
- Man = animal (genus) + with the capacity to reason (differentia)
- Triangle = plane figure (genus) + bounded by three straight lines (differentia)
- Capitalism = political system (genus) + [specific differentia]
...
- Man = the being with the capacity to talk (true only of men, but *because* he has reason)
- Man = the being with a sense of humor (same problem)
- Triangle = the plane figure whose angles sum to 180° (true, but *explained by* the structure of the triangle)
- Capitalism = the system that produces the greatest happiness of the greatest number (true consequence, but not the essence)
...
### Part VIII: Induction and Deduction
