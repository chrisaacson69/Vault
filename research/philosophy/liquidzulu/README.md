...
| Edges of a life | **death end answered in ch. 4:** will = transfer conditioned on death; intestacy = abandonment → homestead race; will-destroyed persons = ownable ("analogous to a corpse") | conception/birth, death/inheritance are where the theory doesn't meet reality (Chris) | **the death end confirms Chris** — his answer violates his own no-gap and definite-owner rules and leaves the comatose outside the theory; **birth end → ch. 5** |
...
| Intent in classification — tally | ch. 2 causation/foreseeability; ch. 4 the intent-to-direct condition on ownership; ch. 4 fraud = deception | intent-blind rule (mens rea page) — which LZ himself holds for *breach* | disagree, and **he holds both rules in one chapter** |
