...
**Links:** [Originalism and the Limiting Document](./originalism-and-the-limiting-document.md) (the keystone — this is a *construction-zone* failure), [Trump v. Anderson](./trump-v-anderson-eligibility.md) (the manner/substance line, here violated), [Wickard v. Filburn](./wickard-v-filburn.md) (the third sibling in the same outcome-engineering pattern), [Registration and Scope Creep](./philosophy/morality/legal-theory/registration-and-scope-creep.md), [The Gödel Governance Problem](./philosophy/dynamics/the-godel-governance-problem.md)
...
- **Kagan (majority):** Article II's power to "appoint... in such Manner as the Legislature may direct" is broad, and the power to *appoint* includes the power to *condition and enforce* the appointment. *Ray v. Blair* (1952) already lets a state *require* an elector pledge; enforcement rides along. The text ("vote by ballot") describes a *mechanism*, not guaranteed discretion. And **liquidation** — a 220-year "open, widespread, unchallenged" practice of electors-as-agents (Federalist 37; *NLRB v. Noel Canning*) — settles the ambiguous text.
- **Thomas (concurring in judgment):** refuses Kagan's expansive appointment reading (it proves too much); grounds the result in the **10th Amendment** — the Constitution is silent on elector discretion, so the power is reserved to the states.

## The franchise distinction (and what was *not* blessed)
...
## Axis 2 — Reasoning: fails (the liquidation bait-and-switch)
...
- **Old and unbroken:** electors *voluntarily* voting the party line.
- **New and immediately challenged:** states *coercing* them with fines and removal. Enforcement statutes with teeth are a 20th-century innovation, essentially untested until *Chiafalo itself*.
...
## Why the founding *opinion* record can't save it
...
## The text supplies discretion without any paper

1. **"Elector"** = one who *elects* = **chooses**. The 1787 sense of "elect" is selection among options, not relaying a foregone result.
2. **"Vote by Ballot"** — the ballot, historically secret, is the *apparatus of free, uncoerced choice*. You prescribe a secret ballot to protect a *decision* from pressure, not to record a predetermined tally.
3. **The text's own contrast:** the 12th Amendment gives the *elector* a "vote by ballot" (a choosing act) and the *President of the Senate* the duty that "the votes shall then be counted" (a ministerial act). The Constitution **distinguishes choosing from tallying** and put the elector on the choosing side. Binding collapses a distinction the text draws on purpose.

This is an argument a textualist should accept — and one did.

## Ray v. Blair is shakier than Chiafalo admits — and Jackson dissented
...
## The pledge distinction — the kill shot
...
- a **condition on appointment** (who may be an elector — legitimate, *manner*), and
- a **command over the federal function** (how the federal vote comes out — illegitimate, *substance*).
...
## Verdict and the interpretive fork
...
- **Living-tradition / Burkean** (Kagan's actual stance): the deliberative model was stillborn, the People relied on pledged electors for two centuries, and 538 free agents would be a destabilizing originalist fantasy nobody wants. *On this philosophy, Chiafalo is correct.*
- **Text-and-purpose-or-amend** (the vault's running thesis): if the EC's purpose is dead, **amend it away** — don't relabel its corpse "tradition" and coerce the form to mimic a function it no longer performs.

## The trilogy — "amend, don't gut"
...
- [Trump v. Anderson](./trump-v-anderson-eligibility.md) — the manner/substance line; Chiafalo both created Anderson's orphan and violates the line that vindicates it.
- [Wickard v. Filburn](./wickard-v-filburn.md) — the third sibling; same outcome-engineering, and Jackson authored Wickard while dissenting *for* elector discretion in *Ray*.
- [Registration and Scope Creep](./philosophy/morality/legal-theory/registration-and-scope-creep.md) — "amend, don't gut" as the discipline regulatory mechanisms evade.
- [The Gödel Governance Problem](./philosophy/dynamics/the-godel-governance-problem.md) — an institution coerced to keep its form after losing its function.
