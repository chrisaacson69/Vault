...
**Sources:**
- [Ballpark Figures — "I Tried to Solve Hangman"](https://www.youtube.com/watch?v=ApdLgfgfh5o) (38:48, 2026-08-23). Author's own script: [`animations/Script.md`](https://github.com/Ballpark-Figures/hangman/blob/main/animations/Script.md) · companion blog: <https://ballparkfigures.substack.com/p/hangman> · the repo's own [`CLAUDE.md`](https://github.com/Ballpark-Figures/hangman/blob/main/CLAUDE.md) (356 lines; the config-canary and scar-ledger patterns lifted from it are recorded in memory, not mirrored here)
