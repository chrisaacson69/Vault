...
**Links:** [AI as a Cognitive Tool](./ai-as-cognitive-tool.md), [The Cyborg Model](./cyborg-model.md), [Risk — The Attrition Constant](./gaming/risk-attrition-odds.md) (**a Layer-2 specimen, dated 2026-08-13** — four mutually-independent verifiers on one small question: a float sweep, a backward recursion in exact rationals, a structurally different reduced chain, and a Monte Carlo that rolls real dice, agreeing to 1e-15. Its instructive failure is a Layer-2 lesson in itself: the Monte Carlo's first seed landed 3σ off and *looked* like a refutation until two more seeds cleared it — **a single-seed simulation is not a verifier**), [Karpathy LLM Wiki Convergence](../notes/karpathy-llm-wiki-convergence.md), [Level 6 — Direct Execution](./level-6-direct-execution.md), [Working With Claude](../notes/working-with-claude.md), [LLM Grounding Problem](./llm-grounding-problem.md), [Career](../career/README.md), [The Contract Model vs. the Substrate Model](./contract-vs-substrate.md) — a per-delivery contract is Verifier+Environment re-authored every task instead of held standing; the agent that "couldn't test it" is a missing Layer 3
