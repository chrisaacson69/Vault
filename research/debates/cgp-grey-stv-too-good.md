...
- **The normative criterion choice** — if the system choice is a value judgment, *which* criterion does Chris weight (Condorcet? monotonicity? locality?)? That's the live argument the impossibility floor opens, not closes.
