...
---
# Does Western Therapy Work for Men? (Spencer Summerhays vs. Michael Gilkison)
...
**Prompt as stated:** *"Modern western therapy doesn't work for men"* — note this is the **opposite polarity** to the channel title
...
> **Mullally:** "If I said like 70% of customers want hamburgers… my question is, **are there salad restaurants?** … Are there therapists who specialize in working with men and maybe use different techniques?"
> **Spencer:** "Probably. There probably are."
> **Michael:** "I'm not certain of that if anything like that exists."
...
- **The 70% stat excludes what Michael is talking about.** Mullally presses on whether the BLS figure covers life coaching and executive coaching. Spencer: *"It did not."* So the two men are describing **different populations** for the entire debate — Spencer's evidence is about licensed psychotherapy, Michael's case is largely about coaching. Neither notices this is why they never touch. Mullally spots it and neither picks it up.
- **A live numerical error, caught by the moderator.** Spencer states 44.8% dropout, then later says *"56% dropped out"*; Michael reads it as 56% *not* dropping out. Mullally intervenes — *"can you clarify now what is the dropout percentage"* — and Spencer corrects himself: 45% dropped out, 56% *of those* cited lack of connection. Good moderation; a debater who misstates his own headline figure mid-round has damaged it regardless.
...
- Forces a definition of *modern western therapy* and gets both to commit (talk therapy, US, post-2000).
- Catches the **population mismatch** — does the 70% figure include life coaching? — which is the round's deepest structural problem.
- Forces the **dropout-number correction** without taking a side on who said what.
- Poses the **"are there salad restaurants?"** question, the actual crux.
- Explicitly labels the limits of his own contributions: *"I'm not an expert in this area"*, *"whether or not they're both modern western therapy I take no position on. I'm just pointing out that there might be a distinction."*
...
**Vault note:** this is **Ryan Mullally's fifth appearance** in this folder — after [birthright citizenship](./sitch-mullally-birthright-citizenship.md), [the Lance Bush metaethics conversation](./lance-bush-mullally-metaethics.md), [Chris's own call-in](./chris-mullally-callin.md), and his listing on the WW1 main card. He also states here that he **won the first Word War Debate in Atlantic City** — which updates the hub, where WW1 was still logged as upcoming.
