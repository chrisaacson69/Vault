...
- **Of what?** The bill? The subject matter? Governance generally? Civics?
- **Graded by whom?** Who writes, administers, and certifies the test?
- **On what standard?** Pass/fail threshold? Score-weighted votes?
- **With what enforcement?** Court challenge? Recall? Automatic disqualification?
...
**Vault anchor:** [constitutive/elective distinction](../philosophy/morality/constitutive-elective.md). Voter-judgment-of-competence is **constitutive** of democracy, not elective. You can't subtract a constitutive feature and still have the thing — any more than you can have triangles with four sides or agency without minds.
...
**Why it dies:**
- **Operationally impossible.** Congress votes constantly — procedural motions, amendments, cloture, confirmations, resolutions. A per-vote test regime stops legislation entirely. Pro has proposed a legislative stoppage, not a competence filter.
- **Disenfranchises constituents.** One CBO staffer's question selection nullifies ~700,000 voters on a specific bill. Decision power transfers from the demos to one unelected question-writer.
- **Collapses into either reading-verification or comprehension-judgment.** Reading-verification is a process reform (attestation, not test) and abandons the resolution's word "understanding." Comprehension-judgment re-imports the who-judges problem at the question-selection level.
...
**Why it dies:**
- **A civics test ain't gonna read a bill.** The motivating concern is *"reps vote on bills they don't understand."* A one-time civics exam does not address that concern. Pro either bait-and-switches (opens with bill-illiteracy examples, proposes civics literacy) or quietly abandons their own framing.
- **High-school-floor trap.** If the bar is what high school graduates used to pass, every voter who graduated high school already cleared it. The electorate exceeds the proposed floor — so voters are fully qualified to judge whether their rep meets it. That's what elections already do.
- **Literacy-test history repeats.** Jim Crow "civics" tests were the historical vector of disenfranchisement. Pro's "neutral civics" framing is the exact rhetorical shape that was used then. Same mechanism, same capture pattern.
- **Grandfathering dilemma.** Does the rule apply to sitting reps? If **yes**, 535 legitimately elected people face retroactive disqualification (legitimacy crisis). If **no**, Pro has conceded that elections legitimize reps regardless of test status — which directly concedes Chris's axiom.
- **Degradation problem.** Competence decays. A test passed at 35 has no bearing on capacity at 75. If the test is one-time, it's a paper credential, not a competence floor. If ongoing, we're back to Version A's operational impossibility.
- **Strictly dominated by existing signals.** Candidates already campaign, debate, give interviews, answer questionnaires. Anyone who wants to assess civic literacy can watch them perform in public for six months. A written exam adds no signal beyond what public performance already provides — it just adds a gatekeeping step disguised as information.
- **Credentialed-institution track record.** Universities, journalism, public health — credentialed gatekeeping didn't produce better outcomes; it produced political monocultures. Legislative credentialism inherits that pattern.
...
**Vault anchor:** This is the [Weighting Problem](./weinstein-murphy-gauge-theory-economics.md) applied to political entry. Weinstein's result: whoever chooses the weights chooses the outcome. Here: whoever writes the test chooses the legislature.
...
- Of the 2,000-page text? Nobody has it, including the authors.
- Of healthcare economics? There are competing schools that disagree on fundamentals — whose school sets the test?
- Of governance? Circular — it's defined by whoever grades.
...
**Vault anchor:** Same problem as [objective morality](../philosophy/morality/constitutive-elective.md) — "fundamental understanding" sounds like a mind-independent object but picks out nothing concrete. It's a label, not a specification.
...
- **Reduce scope** — restore federalism, enumerated powers, narrower federal jurisdiction
- **Reform process** — single-subject rules, mandatory reading periods, shorter bills, public markup
- **Increase transparency** — roll-call disclosure of who wrote what

None of this requires a competence test. All of it addresses the actual problem.

**Vault anchor:** This is the vault's consistent position across every governance debate: [Pool vs Kyla](./pool-kyla-suffrage-taxation.md), [SAVE Act](./save-act-suffrage-hoppian.md), [Gödel Governance](../philosophy/dynamics/the-godel-governance-problem.md) — restrict **scope**, not **participation**.
...
- "Your proposal doesn't remove politics from legislation. It relocates politics from elected representatives to unelected test designers. That's not an improvement — it's a downgrade in accountability."
- "Name me one test question that all sides would accept as neutral. I'll wait."
- "Every literacy test in American history was sold as a neutral competence filter. Yours is different how?"
- "Pilots are experts. Legislators are generalists with expert staff. You're proposing we hire pilots and ignore the passengers."
- "The problem isn't that reps are stupid. It's that Congress is voting on too many things in bills too long on timelines too short. Your test doesn't fix any of that."
- "Elections are already the competence filter. You're proposing to replace a continuous democratic signal with a one-shot written exam. That's a downgrade."
- "Credentialism captured the universities, the press, and public health. Why would it fix Congress?"
...
- **Written** → disadvantages dyslexic reps, blind reps, reps with certain strokes
- **Oral** → disadvantages deaf reps, reps with auditory processing issues (Fetterman)
- **Timed** → disadvantages reps with processing-speed differences, ADHD, anxiety
- **Untimed** → disadvantages nobody but then measures nothing consistent
- **Multiple choice** → rewards pattern-matching, not understanding
- **Essay** → requires graders, who have judgment, which is the who-judges problem
...
- *"Ask yourself if John Fetterman should be allowed to vote. Pennsylvania already answered that question. You're saying they got it wrong."*
- *"The Senate has had a blind senator, a senator with one arm, a senator in a wheelchair, and a senator with a stroke. Your test would have excluded some of them. Which ones, and why do you think you know better than their constituents?"*
- *"Tests measure test-taking. They don't measure judgment, character, or capacity to represent. You're proposing to swap the thing that matters for the thing that's easy to measure."*
- *"Every test format excludes someone. Every accommodation requires a judge. Every judge is a political actor. You haven't designed a competence filter. You've designed a machine for turning disability into partisan advantage."*
...
Every new control point in politics generates new exploits. This is not a bug in the proposal — it's the rule. [Opposing forces](../philosophy/dynamics/opposing-forces.md): any mechanism powerful enough to shape outcomes will have counter-mechanisms built to exploit it. [Gödel governance](../philosophy/dynamics/the-godel-governance-problem.md): adding rules creates exploit surface; the test is another formal system subject to enforcement bypass.
...
- **[SAVE Act and Suffrage](./save-act-suffrage-hoppian.md)** — Hoppian case for restricting franchise; same capture critique applies to restricting the legislature.
- **[Gödel Governance Problem](../philosophy/dynamics/the-godel-governance-problem.md)** — any rule powerful enough to constrain the legislature is itself subject to capture; the test is just another formal system with an enforcement bypass.
- **[Weinstein x Murphy — Weighting Problem](./weinstein-murphy-gauge-theory-economics.md)** — formal result: whoever chooses the weights chooses the outcome. The test is a weighting function over political entry.
- **[Constitutive/Elective](../philosophy/morality/constitutive-elective.md)** — "fundamental understanding" presented as mind-independent but picks out nothing concrete without a designer.
- **Verification layer thesis (memory)** — accumulated democratic state is the verification layer for representatives; one-shot exams delete that accumulated signal.
...
## Tags
[debates](../../tags/debates.md), [philosophy](../../tags/philosophy.md), [libertarian-law](../../tags/libertarian-law.md)
