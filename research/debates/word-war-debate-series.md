...
**⚠ The two readings disagree by a factor of three and the trend is on the losing side of the arithmetic.** Round 1's ballots were pinned tightly by **two-decimal** percentages (94.55 / 5.45 fits **N = 55** exactly; 79.05 / 20.95 fits **N = 105** exactly), which is where [finding 13](#cross-round-findings)'s 30–105 came from. The margin reading says round 2 drew ~834 — an eight-fold jump on a three-fold jump in views, a **24% view-to-vote conversion**. The count reading's 240 fits that trend and fails the card. **Both agree on the consequence:** a round-of-16 match in a $5,000 tournament turned on a swing of **between 20 and 70 voters**. Standing action — **log every raw vote figure a moderator says aloud**; two more and this closes.
