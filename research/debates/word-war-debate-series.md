...
2. **⭐ The bracket's first raw ballot count, and it reconciles to the published card exactly.** Of the [abortion round](./wordwar-r2-abortion-vic-thunder.md): *"he won with an overwhelming amount of votes at **140 total** over his opponent."* Read as Thunder's own count, the whole ballot falls out — **Thunder 140 (58.33%), Kewl Vic 100 (41.67%)**, against a published 58.4 / 41.6. Both inside a tenth of a point, which is strong evidence the reading is right.

**What that second one costs, and it is not small.** A **round-of-16 match with 3,495 views was decided by 240 ballots** — a **6.9% view-to-vote conversion** and a **20-vote swing**. [Finding 13](#cross-round-findings) inferred 30–105 ballots from percentage granularity; this is the first *stated* figure, it is roughly double the top of that range, and it is the same order of magnitude. The finding survives with its estimate widened, and its consequence hardens: **a quarterfinal berth in a $5,000 tournament turned on twenty people.**
