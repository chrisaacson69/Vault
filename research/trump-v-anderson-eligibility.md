...
**Links:** [Originalism and the Limiting Document](./originalism-and-the-limiting-document.md) (the keystone — this case is *directionally right, reasoning unreasonable*), [Online Debates](./debates/README.md) (origin: the Destiny × Ryan stream), [Legal Theory](./philosophy/morality/legal-theory/README.md), [Suffrage, Stakeholdership, and the Scope Problem](./debates/pool-kyla-suffrage-taxation.md) (the lone prior Wickard mention)

## Origin

Steven "Destiny" Bonell streamed a critique of the 9-0 decision; the lawyer-streamer "Ryan" critiqued *that*; Destiny joined to spar directly. The surface fight was an authority fight — Ryan: "a 9-0 holds more weight than a layman's postulating"; Destiny: "there needs to be a *legal argument*." This page is the doctrinal musing that came out of watching the layers get conflated. (The case is **Colorado** — *Trump v. Anderson*, 600 U.S. ___ (2024) — not Arizona; there were parallel state efforts in Maine, Illinois, etc.)
...
- **Ryan is right** that 9-0 settles it — *for the question of state power.* He's wrong if "9-0" is made to imply the Court spoke with one voice on **why**.
- **Destiny is right** that a live legal argument remains (self-execution; Baude & Paulsen). He's wrong because that argument **loses on the specific question in front of the Court** regardless of its merits.

A 9-0 is also not a proxy for correctness — *[Wickard v. Filburn](./wickard-v-filburn.md)* (1942) was unanimous and is a strong candidate for the worst decision SCOTUS ever made. Unanimity ≠ sound reasoning. Wickard is the **methodological sibling** of this case: the same outcome-engineering, in the opposite direction (Wickard *expands* federal power atextually; Anderson's §5-holding *limits* §3 atextually).

## The actual 5-4 split

- **Unanimous (the judgment):** a single state cannot enforce §3 of the 14th Amendment against a *federal* candidate. Structural federalism — no state power over a national office; a patchwork where Trump is eligible in Texas and barred in Colorado is intolerable for one indivisible office.
- **5-4 (the contested reasoning):** the per curiam went further and held that §3 against federal officers can **only** be enforced by *Congressional legislation* under §5 of the 14th Amendment. **Barrett** concurred to say the Court need not decide that. **Sotomayor / Kagan / Jackson** concurred in judgment but attacked the majority for deciding "momentous and difficult issues unnecessarily" — for slamming doors (federal litigation, the count, a §2383 conviction) that didn't need closing.
...
- **McPherson v. Blacker (1892):** the legislature's power over the *manner* of appointing electors is plenary — a state could appoint electors with no popular vote at all.
- **Chiafalo v. Washington (2020):** that power includes binding and penalizing faithless electors. (*Ray v. Blair*, 1952: parties may require elector pledges.)
...
- **Ballot-mechanics patchwork** (A2S1 permits): different signature/deadline rules per state. Affects *access*, tolerable.
- **Eligibility patchwork** (the feared thing): barred in Colorado, eligible in Texas. *Incoherent for a single indivisible office.* A2S1 grants the first; it does not grant the second. "Already granted by A2S1" quietly slides from one to the other.
...
- **Ministerial** qualifications (age, natural-born) are facts a clerk checks — undisputed. States screening *those* at the ballot has never blown up because it's arithmetic, not adjudication.
- **§3 insurrection** is a **contested factual adjudication**. Colorado ran it through C.R.S. § 1-1-113 — a five-day expedited election-challenge trial with relaxed evidentiary rules (the Jan-6 Committee report admitted over hearsay objection) — to make a determination of constitutional magnitude.
...
- ~~A Wickard page~~ — **done:** [Wickard v. Filburn — The Decision That Ate the Enumerated Powers](./wickard-v-filburn.md).
- **Does the manner-power leak into #3 *at all*?** Defending state screening of even *ministerial* eligibility facts would mean a small, principled leak from #1 into #3.
- **Is the 20A terminus strong enough** to resolve a *contested* case (insurrection) rather than a ministerial one, given it never names the decider?
- **Faithless-elector / ineligibility defense** — the untested *Chiafalo* wrinkle above.
- ~~Are state pledge/binding laws themselves constitutional?~~ — **done:** [Chiafalo v. Washington — Binding the Electors](./chiafalo-and-the-deliberative-elector.md). Verdict: wrong on both axes; the case that *created* this page's orphaned-elector problem.
