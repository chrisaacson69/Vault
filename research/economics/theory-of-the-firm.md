...
title: "The Theory of the Firm and the Optimal Scale of Collectives"
---
# The Theory of the Firm and the Optimal Scale of Collectives
...
**Links:** [Economics](./README.md), [Symmetry Breaking](../philosophy/dynamics/symmetry-breaking.md) (the mechanism — optimal size *is* the doctrine of the mean), [Did Christian Societies Actually Outperform?](../philosophy/dynamics/christian-structural-advantage.md) (the historical validation — decentralization won), [The Gödel Governance Problem](../philosophy/dynamics/the-godel-governance-problem.md) (the same law applied to the scale of *power*), [Externalities Fact-Check](./externalities-fact-check.md) (Coase's other half), [Market Efficiency and Human Limits](./market-efficiency-and-human-limits.md), [Jevons for Software](./jevons-software-demand.md) (cheaper internal production of software moves the Coasean build/buy boundary inward — the firm-level face of the elasticity argument)

## Coase's question and the boundary condition
...
|---|---|
| Economies of scale | Hayek's **knowledge problem** — local information can't be centralized without loss (see [econ README](./README.md)) |
...
Optimal size is where these net to zero at the margin. Note the symmetry with [Hayek's price-system argument](./README.md): the knowledge problem is *the* outward pressure — it's the reason a single coordinating mind (a planner, a head office, a capital) degrades as it scales, and why the market beats the firm past a point.

## The generalization — firm → nation → empire
...
- **The Byzantium control:** held Christianity and classical heritage constant but ran the *unified/Caesaropapist* configuration — one big collective — and produced *no* divergence. It preserved the corpus and stagnated.
- **The HRE irony:** the weak, fragmented polity "worked *through* its fragmentation — competing jurisdictions, no single censor," which the page notes "cuts against the unified-confessional-Leviathan prescription. The success case argues against the policy."
- **Endogeneity:** Mokyr / Hume / Diamond — Europe's rise co-varies with fragmentation → inter-state competition.
...
## The pre-political payoff — no scale is terminal
...
- It refutes maximalist universalism ("ever-closer union, the global collective as the goal") — maximizing the collective overshoots the optimum into the knowledge-problem/sclerosis regime.
- It *equally* refutes treating **the nation** as the sacred end-unit — the nation is just another collective, optimal for some functions and wrong for others.
...
1. **Can the optimum be measured, not just argued?** Transaction costs are notoriously hard to quantify; the theory is sharper than its measurements. Is there a tractable proxy (span-of-control data, agency-cost estimates, public-goods-vs-heterogeneity panels)?
2. **Does AI move the curve far enough to change the answer?** If LLM agents collapse internal coordination cost, do optimal firms/states get *larger* (cheaper to coordinate) or *smaller* (cheaper to transact across boundaries)? Both pressures fall; the net is an empirical question and a live one.
3. **Why do collectives so reliably overshoot?** If the optimum is interior, why do firms and states tend to grow *past* it (empire-building, conglomerate bloat)? Candidate: the people who run a collective capture the inward benefits (status, budget) while the outward costs are diffuse — an agency problem about scale itself.

## Tags

[economics](../../tags/economics.md), [philosophy](../../tags/philosophy.md), [history](../../tags/history.md)
