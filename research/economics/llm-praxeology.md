...
**Links:** [Planner-LM Composites](../planner-lm-composites.md) (refines this claim: bare LLMs don't meet the bar, composites do), [Cyborg Model](../cyborg-model.md), [Value and Profit](./value-and-profit.md), [Praxis — Agent Teams](./praxis-agent-teams.md), [Level 6 — Direct Execution](../level-6-direct-execution.md), [Constitutive/Elective Distinction](../philosophy/morality/constitutive-elective.md), [Performative Grounding](../philosophy/morality/is-ought-and-performative-grounding.md), [Relational Objectivity](../philosophy/epistemology/relational-objectivity.md), [Gödel Governance Problem](../philosophy/dynamics/the-godel-governance-problem.md), [Weinstein x Murphy — Gauge Theory Applied to Economics](../debates/weinstein-murphy-gauge-theory-economics.md), [LiquidZulu Course 5 — Children §3](../philosophy/liquidzulu/course-05-childrens-rights.md#3-artificial-intelligence--artificial-intelligence-and-self-ownership) — an ancap theory of AI rights: the awakened AI owns its hardware, training-state AI is not a child
