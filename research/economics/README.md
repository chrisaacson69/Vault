...
- [Jevons for Software](./jevons-software-demand.md) — ***(thesis)*** cheaper code → **more** software spend *if* demand is elastic (|ε| > 1); the 70-year base rate says yes, but **+spend ≠ +coders** (ATM-tellers vs. power-loom-weavers) and **elasticity is a phase**, not a constant. Only *generation* got cheap — the bottleneck migrates to specification and verification
