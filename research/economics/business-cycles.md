...
**Status:** active
**Created:** 2026-03-18
**Links:** [Economics](./README.md), [Risk and Entrepreneurship](./risk-and-entrepreneurship.md), [Value and Profit](./value-and-profit.md), [Civilizational Cycles](../philosophy/civilizational-cycles.md), [Yarvin x McCormack — Fake Science of Economics](../debates/yarvin-mccormack-fake-science-economics.md), [Evo-Cap: Optimal Money Supply](../evolutionary-capitalist/optimal-money-supply.md)
...
## Natural Cycle Drivers

### 1. Entrepreneurial Error Clusters
...
From [Risk and Entrepreneurship](./risk-and-entrepreneurship.md): profit is the reward for correctly navigating uncertainty. Loss is the cost of guessing wrong. When many entrepreneurs guess wrong about the same thing at the same time, loss is *correlated*, and that correlation is what makes it feel like a "cycle" rather than individual failures.

### 2. Innovation Waves and FOMO

Every generation has its bandwagon. Tulips. Railroads. Electricity. Radio. The automobile. The internet. Housing. AI.

The pattern is remarkably consistent:

1. **Genuine innovation** — a real technological advance creates real value (the internet really did change everything)
2. **Early adopters profit** — the first movers capture enormous returns
3. **FOMO cascade** — everyone else sees the profits and piles in, not because they've independently evaluated the opportunity, but because they don't want to miss out
4. **Capital overallocation** — too much money chases the opportunity; projects that would never pencil out get funded because "this time it's different"
5. **Reality check** — the innovation was real but the capital allocation was excessive; the market corrects
6. **Survivors emerge stronger** — Amazon, Google, and Apple survived the dot-com bust. The technology was real. The valuations were not.
...
### 3. Time Preference Shifts

From [Risk and Entrepreneurship](./risk-and-entrepreneurship.md): time preference is the tendency to value present goods over future goods. This preference is not a constant — it shifts with demographics, culture, and historical experience.

- A generation that survived a depression or famine saves aggressively → high savings rate → abundant capital → investment boom
- Their prosperous children, who never experienced scarcity, save less → falling savings rate → capital tightens → contraction
- A population bulge (baby boom) entering peak earning years generates a savings glut; their retirement draws it down
...
### Artificial Credit Expansion (ABCT Proper)

The core Austrian mechanism, correctly understood as amplification:

1. Central bank sets interest rates below the natural rate (the rate that would emerge from voluntary savings)
2. Entrepreneurs receive a *louder* false signal — not just "this looks profitable" (which they'd get anyway from innovation waves) but "this looks profitable AND capital is cheap"
3. The error cluster is therefore *larger* — more entrepreneurs invest in more long-term projects than the genuine savings of the economy can sustain
4. The correction, when it comes, is proportionally more severe
...
- **Deposit insurance** — depositors don't care whether their bank is solvent, removing the market discipline of bank runs
- **Bailouts** — "too big to fail" means the largest institutions face no downside for excessive risk
- **Implicit guarantees** — GSEs (Fannie Mae, Freddie Mac) before 2008 could take on unlimited risk because the market correctly assumed the government would backstop them
...
## The Austrian Position, Corrected
...
1. **Is there an optimal cycle frequency?** If cycles are the market's learning process, is there a pace of boom-bust that maximizes long-run growth? Too fast and capital never has time to accumulate; too slow and malinvestment compounds.
2. **Can you have a free banking system that doesn't produce fractional reserves?** 100% reserve banking has been proposed (Rothbard, de Soto) but has never existed at scale. Is FRB an inevitability of market competition in banking?
3. **Does Schumpeter's creative destruction require a bust?** Or could innovation waves reallocate capital smoothly if the information problem were solved? (Probably not — see [Hayek's distributed computation argument](./README.md) for why the information problem is unsolvable.)
4. **How does the AI bubble resolve?** The innovation is real (like the internet), the FOMO is real (like dot-com), but the government amplification is (so far) modest compared to housing. Does this mean the correction will be milder, or is private FOMO sufficient to create a catastrophic bust on its own?
...
- [Civilizational Cycles](../philosophy/civilizational-cycles.md) — Dalio's 9-stage debt cycle is the macro-scale version of the political ratchet; Olson's institutional sclerosis is the long-run accumulation of deadwood
