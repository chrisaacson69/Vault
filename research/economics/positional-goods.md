...
title: "Positional Goods — Where the Pie Stops Growing, and Why"
---
# Positional Goods — Where the Pie Stops Growing, and Why
> **Positional goods *are* the zero-sum goods** — and "zero-sum" is a property of a **good**, not of an **era**. That identity is the page. The popular story (history was zero-sum until ~1800, then innovation moved us to a growing pie) is a *temporal* frame doing a *categorical* frame's job: nothing about 1800 changed **land**, which was zero-sum then and is zero-sum now. What changed is that a vast non-positional sector grew up alongside it and swamped it by volume. **So we never exited the zero-sum world — we grew a bigger one next to it, and the residual is exactly where housing, rank, and admission live**, which is why the growth is real and nobody feels rescued. A **positional** good is one whose value depends on your share *relative to others*, so producing more cannot help everyone at once. The vault's addition — **Chris's** — is that positionality has **two sources, and only one of them is real**: goods that are *naturally* fixed (rank, status, prime location) and goods that are **manufactured positional** by policy that caps a supply which could otherwise grow (zoning, licensing, accreditation). The empirical payoff is sharp: compare 1963 to now — measured in **hours of median labor**, not a price basket ([why](./measuring-inflation.md)) — and the goods that got dramatically *cheaper* are the non-positional ones, while the ones that got dramatically *dearer* — housing, healthcare, education, childcare — are almost exactly the restricted list. **So the cost-of-living complaint is not evidence against growing-pie. It is evidence of where growth was blocked.**

**Links:** [Economics](./README.md), [Subsistence vs. Participation](./subsistence-vs-participation.md) (**the normative twin — this page is about goods, that one about *needs***), [Inflation](./inflation.md) (Baumol's cost disease — the rival explanation for the expensive list, §4), [Measuring Inflation](./measuring-inflation.md) (the basket fight this page sits underneath), [The Weighting Problem](../philosophy/epistemology/weighting-problem.md), [Absolutes and Differentials](../philosophy/epistemology/absolutes-and-differentials.md), [The Productivity–Pay Gap](./productivity-pay-gap.md), [Poverty in America Is a Sign of Exploitation (prep)](../debates/poverty-exploitation-prep.md), [The Inequality Optimum](./inequality-optimum.md) (**the normative layer — this page says *where* inequality is unavoidable, that one asks *what it is for***), [Theory of the Firm](./theory-of-the-firm.md), [Scope Confusion](../philosophy/morality/scope-confusion.md), [Coordination Without a Coordinator](./coordination-without-a-coordinator.md) (*the wall these goods build when preferences correlate*)

> **Thesis page** (portable). Origin: the [Econ Nerds inequality review](../debates/econ-nerds-inequality-myths.md),
> where "inequality is only bad if the world is zero-sum" needed exactly one qualification and got none.
> Twice discussed in conversation before this and never persisted — the harvest this page recovers.
...
- **Rank and status.** Only 1% of people can be in the top 1%. This is true by construction and no technology touches it.
- **Prime location.** There is one location closest to a given city centre. Beachfront is finite.
- **Fixed-slot admission.** If Harvard admits ~2,000 freshmen, a richer applicant pool does not produce more seats.
...
- Against the left's framing: the expensive list is not evidence that markets fail to serve ordinary people. It is evidence that **these sectors are the least market-allocated ones we have**.
- Against the right's framing: "the pie is growing, stop complaining" is not responsive, because in exactly these sectors **the pie was prevented from growing** — and these are the sectors that dominate a household budget.

This is [Olson's institutional sclerosis](../philosophy/dynamics/civilizational-cycles/structural-institutional.md) and [regulatory scope creep](../philosophy/morality/scope-confusion.md) showing up as a *price*. Incumbents and regulators converge on higher entry barriers for entirely different reasons — rents on one side, legibility and blame-avoidance on the other — which makes it a clean specimen of [convergent interests](../philosophy/dynamics/convergent-interests.md): nobody needs to have planned a housing crisis for one to be produced.

## 3. The empirical test — 1963 vs. now, in hours of labor

The claim is checkable, and the pattern is the whole argument. **Run the comparison in *time-prices* — how many hours of median labor buy the thing — not in a price basket.** The basket apparatus fails here for reasons [Measuring Inflation](./measuring-inflation.md) already documents (there is no correct index; the basket *re-populates* rather than re-weights; new goods break it — the BLS telecom index was off **0.8–1.9pp/yr over 1988–97** purely from omitting cell phones). Time-prices need no deflator, no basket and no base period, which is why they can settle this: 
...
It also reframes the CPI-basket fight ([Measuring Inflation](./measuring-inflation.md)). Whether "inflation" reads as mild or catastrophic depends on how heavily the basket weights the restricted sectors — so the basket dispute is downstream of this page, not independent of it. Weight the abundant goods and everything is cheap; weight housing and healthcare and nothing is affordable. Both baskets are honest. Neither is neutral. That is [the Weighting Problem](../philosophy/epistemology/weighting-problem.md) in its most consequential application.

## 4. The rival explanation, and how to tell them apart

**Baumol's cost disease** ([Inflation §](./inflation.md)) is the innocent account of the same right-hand column: in sectors where productivity cannot rise — because the service *is* a person's time — costs rise relative to sectors where it can. That is real, it needs no villain, and it predicts exactly this list.
...
4. **Positional competition is zero-sum by construction, so it is where the strife lives.** [Absolutes and Differentials](../philosophy/epistemology/absolutes-and-differentials.md) notes that a differential manufactures a counterparty. Positional goods are the case where the differential is not a rhetorical frame choice but a physical fact — and therefore where the differential argument is *legitimate*.
...
- **"Post-scarcity" is a category error, not a distant milestone.** It describes a world where the non-positional basket is abundant, which is already largely true and was never the hard part.
- **There is a permanent constituency for distributional politics** regardless of material conditions, because positional competition cannot be dissolved by growth. That is a structural prediction, and it is the strongest available version of the [elite-overproduction](./subsistence-vs-participation.md) story — surplus aspirants are what a fixed number of top slots *produces*, not a contingent failure of a particular era.
- **It bounds the optimistic case honestly.** Growing-pie is the right answer about goods and the wrong answer about rank. An advocate who concedes this loses nothing and becomes much harder to dislodge.
...
- **What fraction of the expensive column is manufactured vs. natural?** §4 gives a discriminator but not a measurement. Housing looks heavily manufactured, healthcare mixed, elite status irreducibly natural. A sector-by-sector split with numbers would turn this page from an argument into a finding.
- **Do it in *time-prices*, not a basket — the vault already settled this.** The obvious test ("price a 1963 basket today", §3) walks straight into the problem [Measuring Inflation](./measuring-inflation.md) already documents: there is no correct index, the basket **re-populates** rather than re-weights, and new goods break it (the BLS telecom index was off **0.8–1.9pp/yr over 1988–97** purely from omitting cell phones). Chris: *"honestly, I don't think the 'basket of goods' is a good approach to measure inflation."* Correct — and that page's **§4 time-price** instrument sidesteps the whole apparatus: measure each good in **hours of median labor**, then compare 1963 to now. No deflator, no basket, no base-period choice — and it tests this page's central claim directly, since the prediction is that hours-to-buy **fell** for the non-positional column and **rose** for the restricted one. That is the tractable version of §3, and it obeys the rule *match the deflator to the question* by having no deflator at all.
- **Does status positionality have a floor?** If elite slots are fixed by arithmetic, no reform touches them — which suggests a permanent residue of positional competition that growth can never dissolve, and therefore a permanent constituency for inequality politics regardless of material conditions. That may be the deepest version of the [elite overproduction](./subsistence-vs-participation.md) story.
- ~~**Is "post-scarcity" therefore incoherent?**~~ **RESOLVED — promoted to a claim (§7).**
- **Does the manufactured/natural split travel outside economics?** Credentials, prestige, and attention all look manufactured-positional. If so this page is a special case of something larger.

## Tags
[economics](../../tags/economics.md) · [politics](../../tags/politics.md) · [philosophy](../../tags/philosophy.md)
